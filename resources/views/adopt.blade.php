...
@section('layout_content')
    ...
    <div class="flex flex-col space-y-4 sm:flex-row sm:px-20 px-6 pt-2 pb-6">
        <a href="/addcatform" class="flex items-center justify-center text-white bg-secondary hover:bg-primary focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-4 py-2 dark:bg-secondary dark:hover:bg-primary focus:outline-none dark:focus:ring-primary">
