...
<div class=" px-6 pt-2 pb-6 sm:pt-2 sm:pb-6 sm:px-20">
    ...
    <div class="flex flex-row">
        <img src="https://i.imgur.com/3nC88Vo.jpeg" alt="catndip Logo" class="inline-block mr-2 h-10 w-10 my-10">
        <h3 class="my-10 text-3xl font-bold dark:text-white">CatnDip Transactions</h3>
    </div>

    
    <div class="flex flex-col space-y-4 sm:flex-col pb-6 ">
        
        <a href="/addcatndiptransactionsform"
        ...
        <table class=" w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody class="relative">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 relative">
                    ...
                    <td class="px-6 py-4 hover:bg-gray-100 relative change-status" >
                        ...
                        <div
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                    ...
                                    <li>
                                        <form method="POST" action="/changecatndipstatus{{ $transaction->id }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                            @csrf
                                            @method('PUT')
                    ...
                    <td class="px-6 py-4">
                        @if ($transaction->status == "success")
                        <form action="/deletecatndiptransaction/{{ $transaction->id }}" method="POST">
                            @csrf 
                            @method("DELETE")
