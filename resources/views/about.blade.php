...
{{-- <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
      <div class="max-w-2xl">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-600"> Samoir Cattery adalah cattery yang terkemuka dan berdedikasi dalam pembiakan kucing ras British-Scottish Fold/Straight. Kami bangga dengan komitmen kami untuk membiakkan dan mempromosikan kucing-kucing indah ini sambil memastikan kesejahteraan dan kesehatan mereka.
        </p>
      </div>
